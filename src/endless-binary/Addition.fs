...
module Addition =
    ...
    let init () =
        ...
        init' (question 8) questionExpression newHintAdd 2 2 10 Course.keyboardshortcut exec

    let init4 () =
        init' (question 4) questionExpression newHintAdd 2 2 5 Course.keyboardshortcut exec
