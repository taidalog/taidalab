...
module rec Switcher =
    let switch pathname =
        ...
        | "/endless-binary/dec2bin-1/" -> (pathname, EndlessBinary.Course.main Dec2Bin1.help "help-color-d2b", Dec2Bin1.init)
        | "/endless-binary/dec2bin-1/4/" -> (pathname, EndlessBinary.Course.main Dec2Bin1.help "help-color-d2b", Dec2Bin1.init4)
        | "/endless-binary/dec2bin-2/" -> (pathname, EndlessBinary.Course.main Dec2Bin2.help "help-color-d2b", Dec2Bin2.init)
        | "/endless-binary/bin2dec-1/" -> (pathname, EndlessBinary.Course.main Bin2Dec1.help "help-color-b2d", Bin2Dec1.init)
        | "/endless-binary/bin2dec-2/" -> (pathname, EndlessBinary.Course.main Bin2Dec2.help "help-color-b2d", Bin2Dec2.init)
        | "/endless-binary/power-of-two-1/" -> (pathname, EndlessBinary.Course.main PowerOfTwo1.help "help-color-pot", PowerOfTwo1.init)
        | "/endless-binary/power-of-two-2/" -> (pathname, EndlessBinary.Course.main PowerOfTwo2.help "help-color-pot", PowerOfTwo2.init)
        | "/endless-binary/addition/" -> (pathname, EndlessBinary.Course.main Addition.help "help-color-add", Addition.init)
        | "/endless-binary/addition/4/" -> (pathname, EndlessBinary.Course.main Addition.help "help-color-add", Addition.init4)
        | "/endless-binary/subtraction/" -> (pathname, EndlessBinary.Course.main Subtraction.help "help-color-sub", Subtraction.init)
        | "/endless-binary/complement/" -> (pathname, EndlessBinary.Course.main Complement.help "help-color-cmp", Complement.init)
        | "/endless-binary/dec2hex/" -> (pathname, EndlessBinary.Course.main Dec2Hex.help "help-color-d2h", Dec2Hex.init)
        | "/endless-binary/hex2dec/" -> (pathname, EndlessBinary.Course.main Hex2Dec.help "help-color-d2h", Hex2Dec.init)
